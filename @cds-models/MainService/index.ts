...
Object.defineProperty(Task, 'name', { value: 'MainService.Tasks' })
Object.defineProperty(Task, 'is_singular', { value: true })
export class Tasks extends Array<Task> {$count?: number}
Object.defineProperty(Tasks, 'name', { value: 'MainService.Tasks' })
...
Object.defineProperty(TaskStatus, 'name', { value: 'MainService.TaskStatuses' })
Object.defineProperty(TaskStatus, 'is_singular', { value: true })
export class TaskStatuses extends Array<TaskStatus> {$count?: number}
Object.defineProperty(TaskStatuses, 'name', { value: 'MainService.TaskStatuses' })
...
Object.defineProperty(TaskComment, 'name', { value: 'MainService.TaskComments' })
Object.defineProperty(TaskComment, 'is_singular', { value: true })
export class TaskComments extends Array<TaskComment> {$count?: number}
Object.defineProperty(TaskComments, 'name', { value: 'MainService.TaskComments' })
...
Object.defineProperty(TaskTag, 'name', { value: 'MainService.TaskTags' })
Object.defineProperty(TaskTag, 'is_singular', { value: true })
export class TaskTags extends Array<TaskTag> {$count?: number}
Object.defineProperty(TaskTags, 'name', { value: 'MainService.TaskTags' })
...
Object.defineProperty(TaskTagMap, 'name', { value: 'MainService.TaskTagMap' })
Object.defineProperty(TaskTagMap, 'is_singular', { value: true })
export class TaskTagMap_ extends Array<TaskTagMap> {$count?: number}
Object.defineProperty(TaskTagMap_, 'name', { value: 'MainService.TaskTagMap' })
...
Object.defineProperty(TaskStatusHistory, 'name', { value: 'MainService.TaskStatusHistory' })
...
Object.defineProperty(TaskStatusHistory_, 'name', { value: 'MainService.TaskStatusHistory' })
...
Object.defineProperty(TeamMember, 'name', { value: 'MainService.TeamMembers' })
Object.defineProperty(TeamMember, 'is_singular', { value: true })
export class TeamMembers extends Array<TeamMember> {$count?: number}
Object.defineProperty(TeamMembers, 'name', { value: 'MainService.TeamMembers' })
...
Object.defineProperty(TeamCheckin, 'name', { value: 'MainService.TeamCheckins' })
Object.defineProperty(TeamCheckin, 'is_singular', { value: true })
export class TeamCheckins extends Array<TeamCheckin> {$count?: number}
Object.defineProperty(TeamCheckins, 'name', { value: 'MainService.TeamCheckins' })
...
Object.defineProperty(TeamMoodWeekly, 'name', { value: 'MainService.TeamMoodWeekly' })
...
Object.defineProperty(TeamMoodWeekly_, 'name', { value: 'MainService.TeamMoodWeekly' })
...
Object.defineProperty(User, 'name', { value: 'MainService.Users' })
Object.defineProperty(User, 'is_singular', { value: true })
export class Users extends Array<User> {$count?: number}
Object.defineProperty(Users, 'name', { value: 'MainService.Users' })
...
Object.defineProperty(Role, 'name', { value: 'MainService.Roles' })
Object.defineProperty(Role, 'is_singular', { value: true })
export class Roles extends Array<Role> {$count?: number}
Object.defineProperty(Roles, 'name', { value: 'MainService.Roles' })
...
Object.defineProperty(Seniority, 'name', { value: 'MainService.Seniorities' })
Object.defineProperty(Seniority, 'is_singular', { value: true })
export class Seniorities extends Array<Seniority> {$count?: number}
Object.defineProperty(Seniorities, 'name', { value: 'MainService.Seniorities' })
...
Object.defineProperty(Team, 'name', { value: 'MainService.Teams' })
Object.defineProperty(Team, 'is_singular', { value: true })
export class Teams extends Array<Team> {$count?: number}
Object.defineProperty(Teams, 'name', { value: 'MainService.Teams' })
...
Object.defineProperty(Project, 'name', { value: 'MainService.Projects' })
Object.defineProperty(Project, 'is_singular', { value: true })
export class Projects extends Array<Project> {$count?: number}
Object.defineProperty(Projects, 'name', { value: 'MainService.Projects' })
...
Object.defineProperty(Allocation, 'name', { value: 'MainService.Allocations' })
Object.defineProperty(Allocation, 'is_singular', { value: true })
export class Allocations extends Array<Allocation> {$count?: number}
Object.defineProperty(Allocations, 'name', { value: 'MainService.Allocations' })
...
Object.defineProperty(Skill, 'name', { value: 'MainService.Skills' })
Object.defineProperty(Skill, 'is_singular', { value: true })
export class Skills extends Array<Skill> {$count?: number}
Object.defineProperty(Skills, 'name', { value: 'MainService.Skills' })
...
Object.defineProperty(UserSkill, 'name', { value: 'MainService.UserSkills' })
Object.defineProperty(UserSkill, 'is_singular', { value: true })
export class UserSkills extends Array<UserSkill> {$count?: number}
Object.defineProperty(UserSkills, 'name', { value: 'MainService.UserSkills' })
